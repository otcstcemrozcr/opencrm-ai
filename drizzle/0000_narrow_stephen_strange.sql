CREATE TYPE "public"."user_role" AS ENUM('admin', 'manager', 'rep', 'viewer');--> statement-breakpoint
...
CREATE INDEX IF NOT EXISTS "sessions_token_idx" ON "sessions" USING btree ("refresh_token_hash");--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "users_email_org_unique" ON "users" USING btree ("org_id","email");--> statement-breakpoint
