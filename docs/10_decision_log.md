...
| D7 | 2026-06-07 | Opportunity stages: New→Qualified→Discovery→Meeting→Proposal→Negotiation→Won/Lost | Matches vision | Locked |
| D8 | 2026-06-07 | Roles: Admin/Manager/Rep/Viewer | Matches vision RBAC | Locked |
